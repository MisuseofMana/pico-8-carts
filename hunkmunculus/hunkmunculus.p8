...
function chk_for_merge()
	...
	local gen_tile=mget(rmp[1],rmp[2])
	
	-- check all inputs match
	if filled then
		local match=count(input,input[1])
		if match==#input then
			local newspr=matches[input[1]]
			if gen_tile==22 then
				mset(l.spnt[1],l.spnt[2],newspr)
				mset(mt1[1],mt1[2],mt1[3])
				mset(mt2[1],mt2[2],mt2[3])
				sfx(7)
			end
		end
	end
...
leveldata={
		{
			...
			rm={0,0,36,50,7,5},
			goal={45},
			intro="hi! did the wizard send you?",
			lose="",
			win="oh, so he's been a bit sad?",
			banter={},
			txt={
				{"to play, drag the right"},
				{"emotes to the target."},
				{"➡️⬇️⬆️⬅️ moves your hand",8},
				{"hold ❎/x to drag",2},
				{"🅾️/z to reset",2}
			}
		},
		{
			...
			rm={7,0,26,40,9,5},
			goal={30,44,47},
			intro="i can make him a potion.",
			lose="huh? i don't understand?",
			...
			txt={
				{"you can't move emotes"},
				{"through each other,"},
				{"but they don't block you."}
			}
		},
		{
			--lvl 3 witch broomcloset
			rm={0,5,32,33,9,7},
			goal={29,44},
			intro="hey! a little help here!",
			lose="is something wrong?",
			win="what? don't you like jokes?",
			banter={
				"got stuck in my broom closet.",
			},
			txt={
				{"boxes can't be graabed,"},
				{"but they can be pushed"},
				{"onto empty spaces."},
			},
		},
		{
			...
			rm={9,5,40,40,7,5},
			goal={13},
			intro="wanna learn about merging?",
			lose="use the magic circles, buddy.",
			win="that's emotional alchemy!",
			banter={},
			txt={
				{"to create your own emotes"},
				{"drag two matching emotes"},
				{"onto the small magic dots."}
			},
		},
		{
...
function chk_for_lsp(c)
	local found=false
	for o in all(l.sprites) do
		if o.x==c.x and o.y==c.y then
			found=true
		end
	end
	return found
...
function is_trp(c)
	local mtile=mtile_from_px(c)
	local trps={46,47,62,55}
	return count(trps,mtile.ms)>0
end

function is_box_plt(c)
	local mtile=mtile_from_px(c)
	return mtile.ms==44
end

function is_key_plt(c)
	local mtile=mtile_from_px(c)
	return mtile.ms==61
end
...
function is_trp_key(c)
	local mtile=mtile_from_px(c)
	return mtile.ms==47
end

function is_trp_box(c)
	local mtile=mtile_from_px(c)
	return mtile.ms==62
end

function is_pushable(c)
	return is_key(c)
	or is_box(c)
end
__gfx__
...
000000000666660000dddd00766666700bbbbbb007777770777777700ddddd000cccc000aaa000000666600006666000aa1a1aa011181110c1ccc1c091191190
...

...

...

...

...

...
__gff__

...
__map__

...

...

...
01030000125201651011500025001f5001c5001a50000503005030050300503005030050300503005030050300503005030050300503005030050300503005030050300503005030050300503005030050300503
...

